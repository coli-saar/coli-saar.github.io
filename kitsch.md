...
<img src="https://github.com/coli-saar/coli-saar.github.io/blob/main/static/images/kitsch/fake-byron.png?raw=true" width="500px" /><br/>
...
**Why is this paper here and not on Arxiv?**
I submitted this paper to ArXiV on 15 October 2025, not realizing that
ArXiV [had just decided to enforce their policy of not accepting opinion papers](https://blog.arxiv.org/2025/10/31/attention-authors-updated-practice-for-review-articles-and-position-papers-in-arxiv-cs-category/).
The paper got stuck in a loop for a few weeks; now I finally had the time to create a
blog page for the paper under my own control (12 November 2025).
